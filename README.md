...
Спарк складывает данные в формат csv. Несмотря на небольшой размер файла, спарк был выбран исключительно ради достижения образовательных целей.
...
Цифры, вычисленные на основе сырых данных, сходятся с отчетами USDA, что может говорить о правильно проведенной обработкe данных.
